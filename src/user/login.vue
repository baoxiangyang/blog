<template>
  <el-dialog :title="isLogin ? '用户登录' : '找回密码'" :visible="dialogLogin" :lock-scroll="false" size="tiny" class="loginDialog" :before-close="handelBeforeClose">
    ...
    methods: {
      ...
      enter(el){
        ...
        /*if(el.className.indexOf('loginForm') == -1){
          ...
          toggleLgoin.style.height="270px";
        }*/
      }
    },
    watch: {
